...
namespace Jarai.Patterns.Creational.Builder
{
     ...
     * We want to build objects, but its construction is complex because of the many
     * parameters needed. To aid the user we introduce Builder class. Hero.Builder 
     * takes the minimum parameters to build Hero object in its constructor. After that
     * additional configuration for the Hero object can be done using the fluent
     * Builder interface. When configuration is ready the build method is called to receive
     * the Hero object.
     */
    public class App
    {
